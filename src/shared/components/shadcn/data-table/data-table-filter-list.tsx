...
import { Badge, Button, InputShadcn } from '@/src/shared/components/shadcn';
import {
  Popover,
  PopoverTrigger,
} from '@/src/shared/components/shadcn/popover';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@/src/shared/components/shadcn/select';
...
import {
  ...
  CommandItem,
  CommandList,
} from '@/src/shared/components/shadcn/command';
...
import { Calendar } from '@/src/shared/components/shadcn/calendar';
...
export function DataTableFilterList<TData>({
  ...
  return (
    <Sortable
      ...
      getItemValue={(item:ColumnFiltersState[number]) => item.id}
    >
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent
          ...
          className="flex w-full bg-background z-10 max-w-(--radix-popover-content-available-width) flex-col gap-3.5 p-4 sm:min-w-[380px]"
          {...props}
        >
