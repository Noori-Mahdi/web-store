...
import type { ColumnSort, SortDirection, SortingState, Table } from '@tanstack/react-table';
import {
  ArrowDownUp,
  ChevronsUpDown,
  GripVertical,
...
import { Badge } from '@/src/shared/components/shadcn/badge';
...
export function DataTableSortList<TData>({
  ...
  return (
    <Sortable
      ...
      getItemValue={(item: SortingState[number]) => item.id}
    >
